...
- [ ] W1  `weather.py` — parse_geocode + parse_open_meteo (pure, TDD) + network wrappers
         geocode_city/fetch_open_meteo/fetch_weather_for_city
- [ ] W2  `app.py` — weather panel source selector (Off / Auto Open-Meteo / Manual);
         Auto fetches by city (cached) → weather_mult (AppTest)
- [ ] W3  README weather/auto section; roadmap update; full suite green
